...
file_path = string.gsub(file_path, "config.lua","");
...
if((partId == 1642) or (partId == 1843)) then
    if(ar1.ProfileConfig(0, 77, 30, 6, 2000, 0, 0, 0, 0, 0, 0, 1.979, 0, 2048, 2000, 0, 0, 30)== 0) then
...
if (ar1.FrameConfig(0, 0, 17, 255, 518, 0, 0, 1) == 0) then
